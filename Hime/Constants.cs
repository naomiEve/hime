...
namespace Hime
{
    ...
    {
        // MIME mappings from extensions to MIME formats
        internal static readonly Dictionary<string, string> mimeMappings = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
        {
